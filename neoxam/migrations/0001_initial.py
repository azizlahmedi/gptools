# Generated by Django 3.2.18 on 2023-03-31 23:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procedure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='neoxam.pprocedure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('procedure_revisions', models.ManyToManyField(related_name='batches', to='neoxam.ProcedureRevision')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('output', models.TextField(blank=True)),
                ('compiler', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='neoxam.compiler')),
                ('procedure_revision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='neoxam.procedurerevision')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compiler', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='neoxam.compiler')),
            ],
            options={
