...
from factory_app import consts, managers, settings
...
class Task(models.Model):
    ...
    compiler = models.ForeignKey(Compiler, related_name='tasks', blank=True, null=True, on_delete=models.SET_NULL)
