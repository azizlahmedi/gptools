...
class ProcedureVersion(models.Model):
    ...
    procedure = models.ForeignKey(Procedure, related_name='procedure_versions',on_delete=models.CASCADE)
    commit = models.ForeignKey(Commit, related_name='procedure_versions',on_delete=models.CASCADE)
    data = jsonfield.JSONField()
